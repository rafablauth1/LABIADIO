...
export function FilterPill({
  ...
  return (
    <button
      ...
      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-pill text-[11px] font-medium whitespace-nowrap transition-all duration-150 select-none ${className}`}
      style={{
