...
const SPRINTS: Sprint[] = [
  ...
  },
  {
    ...
    status: 'andamento', pct: 85, inicio: '2026-04-19', fim: '2026-05-10',
    entregas: [
      ...
      'Documentos Normativos com normas pré-cadastradas e PDF',
      'Incerteza de Medição — calculadora GUM interativa',
      'Condições Ambientais — planilha mensal + medidores',
    ],
  },
  {
    id: 'S3', nome: 'Checagens',
    descricao: 'Controle e realização de checagens internas com cálculo automático',
    status: 'iniciado', pct: 30, inicio: '2026-05-11', fim: '2026-05-25',
    entregas: [
  ...
  {
    id: 'S4', nome: 'IA Consultora',
    descricao: 'Análise automática de certificados e relatórios via IA',
    status: 'planejado', pct: 0, inicio: '2026-05-26', fim: '2026-06-15',
    entregas: [
  ...
  {
    id: 'S5', nome: 'Auth Microsoft',
    descricao: 'Login SSO com conta corporativa Microsoft 365',
    status: 'planejado', pct: 0, inicio: '2026-06-16', fim: '2026-06-30',
    entregas: [
